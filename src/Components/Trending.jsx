...
const Trending = () => {
  return (
    <div className="max-w-6xl items-center justify-center mx-auto px-2 space-y-6 pb-12 mt-15">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-6">
        <div className="border border-orange-900/20 rounded-2xl outline-none h-[380px] hover:shadow-xl transition bg-[#f2efef] cursor-pointer space-y-4 ">
          <div>
            <img
              src={assets.The_Urban_Kitchen}
              alt=""
              className="w-full h-[200px] rounded-t-2xl overflow-hidden"
            />
          </div>
          ...
          <div className="px-4 space-y-4">
            ...
            <div className="flex justify-between items-center">
              ...
              <button className="bg-orange-600/15 p-2 px-6 rounded-xl text-orange-500 font-bold hover:bg-orange-500 hover:text-white">
                + Order
              </button>
            </div>
          </div>
        ...
        <div className="border border-orange-900/20 rounded-2xl outline-none h-[380px] hover:shadow-xl transition bg-[#f2efef] cursor-pointer space-y-4 ">
          ...
          <div className="px-4 space-y-4">
            <div className=" space-y-2">
              <div className="flex justify-between items-center">
                <h1 className="text-2xl font-bold">Bella Napoli</h1>
                <i className="text-orange-500 font-bold">$$</i>
              </div>
              <p className="opacity-50">Italian • Pasta • Traditional</p>
            </div>
            {/* <div> */}
            <hr className="opacity-10" />
            {/* </div> */}
            <div className="flex justify-between items-center">
              <p className="opacity-50">Free delivery</p>
              <button className="bg-orange-600/15 p-2 px-6 rounded-xl text-orange-500 font-bold hover:bg-orange-500 hover:text-white">
                + Order
              </button>
            </div>
        ...
        <div className="border border-orange-900/20 rounded-2xl outline-none h-[380px] hover:shadow-xl transition bg-[#f2efef] cursor-pointer space-y-4 ">
          ...
          <div className="px-4 space-y-4">
            <div className=" space-y-2">
              <div className="flex justify-between items-center">
                <h1 className="text-2xl font-bold">Taco Fiesta</h1>
                <i className="text-orange-500 font-bold">$</i>
              </div>
              <p className="opacity-50">Mexican • StreetFood • Tacos</p>
            </div>
            {/* <div> */}
            <hr className="opacity-10" />
            {/* </div> */}
            <div className="flex justify-between items-center">
              <p className="opacity-50">Popular for lunch</p>
              <button className="bg-orange-600/15 p-2 px-6 rounded-xl text-orange-500 font-bold hover:bg-orange-500 hover:text-white">
                + Order
              </button>
            </div>
