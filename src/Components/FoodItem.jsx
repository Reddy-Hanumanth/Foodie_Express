          ...
          <div className="px-3 py-2 flex flex-col gap-4">
            ...
            <div className="flex flex-col gap-3">
              <div className="flex text-center justify-between gap-1 bg-[#f4eae7] p-2 text-lg font-semibold rounded-lg">
                <button
                  className="hover:bg-white px-3 rounded-lg"
              ...
              <div>
                <button
                  className="bg-orange-500 font-semibold p-2 w-full rounded-xl text-white space-x-4 hover:bg-orange-600"
                  onClick={() => {
                    if (quantity > 0) {
                      addToCart({ _id, name, price, image }, quantity);
                      setQuantity(0)
                    }
                  }}
                >
